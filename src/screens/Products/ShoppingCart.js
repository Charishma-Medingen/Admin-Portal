                                    ...
                                    <div className="product-cart">
                                        ...
                                        <div className="checkout-btn d-flex justify-content-between pt-3 flex-wrap mt-2">
                                            <div className="single-btn w-sm-100">
                                                <Link to={"/product-grid"} className="btn btn-secondary w-sm-100">Continue Shopping</Link>
                                            </div>
                                            <div className="single-btn w-sm-100">
                                                <Link to={"/check-out"} className="btn btn-primary w-sm-100">Proceed to Checkout</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>

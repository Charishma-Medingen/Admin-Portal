...
export const OrderVoiceData = {
    ...
    columns: [
        ...
        },
        {
            ...
            cell: () =>
                <div>
                    <Link type="button" to={'/invoices'} className="btn btn-outline-secondary"><i className="icofont-print fs-5"></i></Link>
                    <Link type="button" to={'/invoices'} className="btn btn-outline-secondary deleterow mx-1"><i className="icofont-download fs-5"></i></Link>
                    <Link type="button" to={'/invoices'} className="btn btn-outline-secondary deleterow"><i className="icofont-send-mail fs-5"></i></Link>
                </div>,
                minWidth: "200px"
        }
    ],

                    ...
                    <div className="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 className="fw-bold mb-0">{pagetitle}</h3>
                        {
                            routebutton ? <div className="col-auto d-flex w-sm-100">
                                <Link to={link} className="btn btn-primary btn-set-task w-sm-100"><i className="icofont-plus-circle me-2 fs-6"></i>{righttitle}</Link>
                            </div> : null
                        }
                        {
                        ...
                        {/* {
                            productgrid ? <div className="btn-group group-link btn-set-task w-sm-100">
                                <Link to={"/product-grid"} className="btn active d-inline-flex align-items-center" aria-current="page"><i className="icofont-wall px-2 fs-5"></i>Grid View</Link>
                                <Link to={"/product-list"} className="btn d-inline-flex align-items-center"><i className="icofont-listing-box px-2 fs-5"></i> List View</Link>
                            </div> : null
                        }
                        {
                            productlist ? <div className="btn-group group-link btn-set-task w-sm-100">
                                <Link to={"/product-grid"} className="btn  d-inline-flex align-items-center" aria-current="page"><i className="icofont-wall px-2 fs-5"></i>Grid View</Link>
                                <Link to={"/product-list"} className="btn active d-inline-flex align-items-center"><i className="icofont-listing-box px-2 fs-5"></i> List View</Link>
                            </div> : null
                        } */}
                        {
                            cantactus ?
